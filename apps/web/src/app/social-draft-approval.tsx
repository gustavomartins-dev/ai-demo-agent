...
export function SocialDraftApproval({ draftId, approvedAt, platform }: { draftId: string; approvedAt: string | null; platform: "X" | "LINKEDIN" }) {
  ...
  return (
    <form action={action} className="mt-4 rounded-xl border border-emerald-400/15 bg-emerald-400/[0.05] p-4">
      ...
      <p className="text-xs leading-5 text-emerald-100/70">Approval freezes the currently saved text{platform === "LINKEDIN" ? " and the latest ready demo video" : ""}. It does not publish anything.</p>
